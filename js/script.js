...
calculate.onclick = (e) => {
   ...
   if (isMonth == '' && isYear == '') {
      alert('Por favor, selecione o tipo de prazo do empréstimo -> Mês ou ano');
   } else {
      ...
      document.getElementById('emi').innerHTML = ' R$' + Math.round(emi);
      document.getElementById('totalInterest').innerHTML = 'R$ ' + Math.round(totalInterest);
      document.getElementById('totalPayment').innerHTML = 'R$ ' + Math.round(totalPayment);
